...
public class WFM_EMP_VACATION_Controller_Impl implements WFM_EMP_VACATION_Controller {
    ...
    public ResponseEntity<APIResponse> insertEmpVac(long empId, WFM_EMP_VACATION_Req wfmEmpVacationReq) {
        ...
        try {
            ...
            return empVacationService.insertEmpVac(empId,wfmEmpVacationReq);
        } catch (Exception ex) {
            ex.printStackTrace();
            apiResponse.setStatus(HttpStatus.INTERNAL_SERVER_ERROR);
            apiResponse.setStatusCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
    ...
    public ResponseEntity<APIResponse> updateEmpVac(long empId, WFM_EMP_VACATION_Req wfmEmpVacationReq) {
        ...
        try {
            System.out.println("kkiioo");
            System.out.println(empId);
            return empVacationService.updateEmpVac(empId,wfmEmpVacationReq);
        } catch (Exception ex) {
            ex.printStackTrace();
            apiResponse.setStatus(HttpStatus.INTERNAL_SERVER_ERROR);
            apiResponse.setStatusCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
    ...
    public ResponseEntity<APIResponse> deleteEmpVac(String vacId) {
        ...
        try {
            ...
            return empVacationService.deleteEmpVac(vacId);
        } catch (Exception ex) {
            ex.printStackTrace();
            apiResponse.setStatus(HttpStatus.INTERNAL_SERVER_ERROR);
            apiResponse.setStatusCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
    ...
    public ResponseEntity<APIResponse> getVacationOfEmployeeById(long empId) {
        ...
        try {
            System.out.println("kkiioo");
            System.out.println(empId);
            return empVacationService.getVacationOfEmployeeById(empId);
        } catch (Exception ex) {
            ex.printStackTrace();
            apiResponse.setStatus(HttpStatus.INTERNAL_SERVER_ERROR);
            apiResponse.setStatusCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
