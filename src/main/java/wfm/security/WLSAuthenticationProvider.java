...
import wfm.repos.UserPermissionRepo;
import wfm.repos.UserRepo;
import wfm.services.SysConfigService;
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		System.out.println("name in WLSAuthenticationProvider = " + name);
        	...
        	if(name!= null) {
    			...
    			wfm.models.User user = this.userRepository.findByUSERNAME(name);
    			...
    			wfm.models.User user = this.userRepository.findByUSERNAME(userNAME);
